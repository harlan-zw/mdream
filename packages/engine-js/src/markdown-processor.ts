...
import type { ElementNode, EngineOptions, HandlerContext, NodeEvent, Plugin, PluginContext, TextNode } from './types'
import {
 ...
 */
export function createMarkdownProcessor(options: EngineOptions = {}, resolvedPlugins: Plugin[] = []) {
