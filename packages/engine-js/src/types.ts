 ...
 * These are imperative hook-based plugins that only work with the JavaScript engine.
 * For declarative config that works with both JS and Rust engines, use `PluginConfig`.
 */
