...
mod tests {
    ...
    fn strip_tracking_borrows_when_clean() {
        ...
        assert!(matches!(strip_tracking_params("https://x.com/a"), Cow::Borrowed(_)));
        // query with only non-tracking params — borrowed
        assert!(matches!(strip_tracking_params("https://x.com/a?id=1"), Cow::Borrowed(_)));
    }

    #[test]
    fn strip_tracking_removes_params() {
        assert_eq!(strip_tracking_params("https://x.com/a?utm_source=n"), "https://x.com/a");
        assert_eq!(
    ...
    fn resolve_url_passthrough() {
        ...
        assert_eq!(resolve_url("#anchor", Some("https://x.com"), true), "#anchor");
        // absolute URL with no origin and no cleaning — unchanged
        assert_eq!(resolve_url("https://x.com/a", None, false), "https://x.com/a");
    }

    #[test]
    fn resolve_url_protocol_relative() {
        assert_eq!(resolve_url("//cdn.x.com/a.js", None, false), "https://cdn.x.com/a.js");
    }
    ...
    fn slugify_strips_inline_markdown() {
        ...
        assert_eq!(slugify_heading("See [the docs](https://x.com)"), "see-the-docs");
